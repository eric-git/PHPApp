...
cp /etc/ssl/$DOMAIN/$DOMAIN.crt /usr/local/share/ca-certificates/$DOMAIN.crt
...
EOL
cat "${SCRIPT_DIR}/php-settings-debian.ini" >> /etc/php/${phpVersion}/apache2/conf.d/99-${DOMAIN}.ini
